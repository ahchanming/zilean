...
inline static bool init(CURL*& conn, const char* url, std::string* p_buffer)
{
	CURLcode code;
...
inline static int writer(char* data, size_t size, size_t nmemb, std::string* writer_data)
{
...
inline int doGet(const char* url, std::string& buffer, std::string& errinfo)
{
...
inline int doPost(const char* url, const char* data, std::string& buffer, std::string& errinfo)
{
	CURL *conn = NULL;
	CURLcode code;
